...
func (app *application) ReportSubscription(email, name string) error {
	...
	mail.SetBody("text/html", ReturnWelcome(name))

	send := gomail.NewDialer(app.config.smtp.prov, app.config.smtp.sport, app.config.smtp.user, app.config.smtp.password)
...
func (app *application) SendContactForm(name, email, desc string) error {
	mail := gomail.NewMessage()

	mail.SetHeader("From", app.config.smtp.user)
	mail.SetHeader("To", app.config.personal.puser)

	mail.SetHeader("Subject", "Nuevo contacto")
...
func ReturnContact(name, email, desc string) string {
	return `
...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_heading_2 .v-font-size { font-size: 17px !important; } #u_content_text_deprecated_1 .v-container-padding-padding { padding: 40px 10px !important; } #u_content_text_deprecated_1 .v-line-height { line-height: 180% !important; } }
    </style>
...
<table id="u_content_text_deprecated_1" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height v-font-size" style="line-height: 180%; text-align: justify; word-wrap: break-word;">
    <p style="line-height: 180%;">Hola mi nombre es ` + name + `</p>
<p style="line-height: 180%;">Mi correo es ` + email + `</p>
<p style="line-height: 180%;"> </p>
<p style="line-height: 180%;">` + desc + `</p>
<p style="line-height: 180%;"> </p>
  </div>
...
func ReturnWelcome(name string) string {
	return `
	<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
<head>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 style="margin: 0px; color: #df1f1f; line-height: 140%; text-align: left; word-wrap: break-word; font-family: Bitter; font-size: 18px; "><strong>Hola ` + name + `</strong></h1>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-family: 'Montserrat',sans-serif; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 140%;">Gracias por queres ser parte de esta gran familia.</p>
<p style="line-height: 140%;">Estate enterado de noticias, futuros proyectos, descuentos, promociones.</p>
<p style="line-height: 140%;">Te agradecemos mucho tu interes.</p>
  </div>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://resources.ismanpublicidad.com/email/image-1.png" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 500px;" width="500"/>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: Bitter; font-size: 18px; "><strong>Mas grandes deseos, Isman Publicidad<br /></strong></h1>
